...
export class WeddingService {
  ...
  public getContentOne():string[]{
    ...
    arr.push(str);
    str="Vi designer og fremstiller ringe i alle materialer og i alle prisklasser, så mulighederne er mange.";
    arr.push(str);
  ...
  public getContentTwo():string[]{
    ...
    arr.push(str);
    str="Vi vejleder jer naturligvis gerne i forhold til bæredygtige valg af materialer og ædelsten. I er i centrum.";
    arr.push(str);
  ...
  public getImages():string[]{
    ...
    let img2 = "../../assets/img/wedding/4.jpg";
